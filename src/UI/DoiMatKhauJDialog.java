...
public class DoiMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnDoiMatKhau.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PG/Icon/Create.png"))); // NOI18N
        ...
        btnHuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PG/Icon/Delete.png"))); // NOI18N
   ...
   ToanCuc tt = new ToanCuc();
    ...
    private void init() {
        ...
        txtMaNV.setText(tt.getMa());
        txtMaNV.setEnabled(false);
    }

    private boolean doiMatKhau() {
        if (txtMaNV.getText().isEmpty() || txtMatKhau.getPassword().equals("") || txtMatKhauMoi.getPassword().equals("") || txtMatKhauMoi2.getPassword().equals("")) {
            ...
            if (!manv.equalsIgnoreCase(nd.getUserID())) {
...
//            Auth.user.setMatKhau(matKhauMoi);
                //dao.update(new String nd.getPassWord());
                nd.setPassWord(matKhauMoi2);
                nd.setVaiTro(tt.getVaitro());
                nd.setUserID(manv);
                dao.update(nd);
